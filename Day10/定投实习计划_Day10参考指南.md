# P1 - Day 10 参考指南：月度复盘 · 第二笔定投 · 创建月度汇报 Skill
...
- 复制进**报告模板副本**的第二节（copy 一份 `报告模板.md` 填入，副本如 `justin-Day10报告.md`）
- 复制进 `Day10/report/月度汇报_2026年7-8月.md` 的**第一节**，其余五节自己填写

> `报告模板.md` 保持空白，不要直接填。只填副本。
